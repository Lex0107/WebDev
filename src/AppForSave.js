...
import myImage13 from './assets/Union.png';
...
function App() {
  return (
    <div className="App">
      <header className="App-header">
       ...
       <div className='w-full flex pt-[30px]'>
        ...
        <div className='w-full flex place-content-between'>
          <div className='flex px-[20px]'>{/* Logo */}
            <img src={myImage6} alt="My Image" />
          </div>
          <div className='flex px-[20px]'>{/* Menu */}
            <img src={myImage7} alt="My Image" />
          </div>
        </div>
      </div>

        <div className='w-full flex flex-col pt-[40.39px]'>
        {/*Intro */}
        ...
        {/*Services*/}
          ...
          <div className='flex px-[10px] pt-[30px] justify-center'>{/* Text */}
            <span className='text-centre px-[10px] font-space-grotesk font-normal text-[16px] leading-[24px] text-black'>At our digital marketing agency, we offer a range of services to help businesses grow and succeed online. These services include:</span>
          </div>
            ...
            <div className='flex flex-col bg-customColor border border-black rounded-[45px] shadow-black shadow-md'>
              <div className='p-[50px]'>
                ...
                <div className='flex place-content-between'>
                  ...
                  <div className='flex'>
                    <img src={myImage10} alt="My Image10" />
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className='w-full flex flex-col pt-[70.53px]'>
        {/*Let’s make things happen */}
          <div className=' flex px-[20px]'>
            <div className='w-full flex flex-col  space-y-[20px] p-[50px] bg-gray-100 rounded-[45px] justify-center'>
              <div className='flex justify-center'>{/* Main text */}
                <span className='text-left px-5 font-space-grotesk font-medium text-[26px] leading-[33.18px] text-black'>Let’s make things happen</span>
              </div>
              <div className='flex px-[10px] justify-center'>{/* Text */}
                <span className='text-left px-[10px] font-space-grotesk font-normal text-[16px] leading-[24px] text-black'>Contact us today to learn more about how our digital marketing services can help your business grow and succeed online.</span>
              </div>
              <div className='flex pt-[40px] justify-center'>{/* Button */}
        ...
        <div className='flex flex-col pt-[40px] px-[20px] space-y-[30px]'>{/* Blocks */}
          {/* Block - 1 */}
          <div className='flex flex-col bg-gray-100 border border-black rounded-[45px] shadow-black shadow-md'>
            <div className='flex flex-col px-[50px] py-[40px] space-y-[20px]'>
              <div className='flex justify-center justify-items-center'>
                <img src={myImage3} alt="My Image" />
              </div>
              <div className='flex border-2 border-gray-400'></div>
              <div className='flex justify-center justify-items-center'>
                <span className='text-left px-[10px] font-space-grotesk font-normal text-[16px] leading-[24px] text-black'>10+ years of experience in digital marketing. Expertise in SEO, PPC, and content strategy</span>
              </div>
            </div>
          </div>
          {/* Block - 2 */}
          <div className='flex flex-col bg-gray-100 border border-black rounded-[45px] shadow-black shadow-md'>
            <div className='flex flex-col px-[50px] py-[40px] space-y-[20px]'>
              ...
              <div className='flex border-2 border-gray-400'></div>
              <div className='flex justify-center justify-items-center'>
                <span className='text-left px-[10px] font-space-grotesk font-normal text-[16px] leading-[24px] text-black'>7+ years of experience in project management and team leadership. Strong organizational and communication skills</span>
              </div>
            </div>
          </div>
          {/* Block - 3 */}
          <div className='flex flex-col bg-gray-100 border border-black rounded-[45px] shadow-black shadow-md'>
            <div className='flex flex-col px-[50px] py-[40px] space-y-[20px]'>
              ...
              <div className='flex border-2 border-gray-400'></div>
              <div className='flex justify-center justify-items-center'>
                <span className='text-left px-[10px] font-space-grotesk font-normal text-[16px] leading-[24px] text-black'>5+ years of experience in SEO and content creation. Proficient in keyword research and on-page optimization</span>
              </div>
            </div>
          </div>
          {/* Block - 4 */}
          <div className='flex flex-col bg-gray-100 border border-black rounded-[45px] shadow-black shadow-md'>
            <div className='flex flex-col px-[50px] py-[40px] space-y-[20px]'>
              ...
              <div className='flex border-2 border-gray-400'></div>
              <div className='flex justify-center justify-items-center'>
                <span className='text-left px-[10px] font-space-grotesk font-normal text-[16px] leading-[24px] text-black'>3+ years of experience in paid search advertising. Skilled in campaign management and performance analysis</span>
              </div>
            </div>
          </div>
        </div>
        <div className='flex justify-center pt-[38.71px]'>{/* Button */}
        ...
        {/* Contact us */}
          ...
          <div className='flex flex-col pt-[40px] px-[20px]'>{/* Blocks */}
            <div className='flex flex-col bg-gray-100 rounded-[45px]'>
              <div className='w-full flex px-[60px] place-content-between pt-[40px] space-x-[60px] justify-center'>
              ...
              <div className='flex flex-col px-[30px] space-y-[20px] pt-[36px] pb-[40px]'>{/* Inputs */}
          ...
          <div className='flex justify-center pt-[38.71px] px-[20px]'>{/* Button */}
      ...
      <div className='w-full flex flex-col pt-[60px] bg-customColor'>
        {/* Footer */}
